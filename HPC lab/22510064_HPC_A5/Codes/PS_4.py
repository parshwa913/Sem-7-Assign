...
plt.legend()
plt.tight_layout()
plt.savefig("PS_4_Execution_Time_vs_Threads.png")
plt.show()
...
plt.legend()
plt.tight_layout()
plt.savefig("PS_4_Speedup_vs_Threads.png")
plt.show()
...
plt.grid(True)
plt.tight_layout()
plt.savefig("PS_4_Execution_Time_vs_DataSize.png")
plt.show()
