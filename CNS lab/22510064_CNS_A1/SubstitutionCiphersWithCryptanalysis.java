...
public class SubstitutionCiphersWithCryptanalysis {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Caesar Decrypted: " + caesarDecrypt(caesarEnc, 3));
        caesarCryptanalysis(caesarEnc);

        // Playfair
        String playfairEnc = playfairEncrypt(plain, "MONARCHY");
        System.out.println("\nPlayfair Encrypted: " + playfairEnc);
        System.out.println("Playfair Decrypted: " + playfairDecrypt(playfairEnc, "MONARCHY"));
        ...
        System.out.println("Vigenère Decrypted: " + vigenereDecrypt(vigenereEnc, "KEY"));
